...
int main()
{
	...
	if (inputFile)
	{
		...
		while (columncounter <= 7)
		{
			...
			auto largest = max_element(counterarray.begin() , counterarray.end());
			cout << "Here is the most common letter in column " << columncounter << ": " << *largest << endl;
			cout << endl; 

			cout << "Finding position of largest element of counterarray in column " << columncounter << ": " << endl;
			auto position = distance(counterarray.begin() , largest);
			cout << "Found largest at position " << position << "." << endl;
			cout << endl;
